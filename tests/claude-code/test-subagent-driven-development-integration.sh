...
mkdir -p src test docs/tungnt-ai-skills/plans

# Create a simple implementation plan
cat > docs/tungnt-ai-skills/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/tungnt-ai-skills/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/tungnt-ai-skills/plans/implementation-plan.md using the subagent-driven-development skill.
