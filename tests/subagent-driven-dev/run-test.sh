...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/tungnt-ai-skills
...
PROMPT="Execute this plan using tungnt-ai-skills:subagent-driven-development. The plan is at: $PLAN_PATH"
