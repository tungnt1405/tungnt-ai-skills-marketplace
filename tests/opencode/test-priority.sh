...
# Test 2: Document personal vs bundled tungnt-ai-skills priority
echo ""
echo "Test 2: Documenting personal vs tungnt-ai-skills priority..."
...
describe_priority_result \
    ...
    "Current OpenCode behavior loaded bundled tungnt-ai-skills version instead of personal version"

# Test 3: Document project vs bundled tungnt-ai-skills priority
echo ""
echo "Test 3: Documenting project vs personal/tungnt-ai-skills priority..."
...
describe_priority_result \
    ...
    "Current OpenCode behavior loaded bundled tungnt-ai-skills version instead of project version"

# Test 4: Test a non-colliding bundled tungnt-ai-skills skill is still available
echo ""
echo "Test 4: Testing non-colliding tungnt-ai-skills skill remains available..."

mkdir -p "$SUPERPOWERS_SKILLS_DIR/tungnt-ai-skills-only-test"
cat > "$SUPERPOWERS_SKILLS_DIR/tungnt-ai-skills-only-test/SKILL.md" <<'EOF'
---
name: tungnt-ai-skills-only-test
description: tungnt-ai-skills-only priority test skill
---
# tungnt-ai-skills Only Test Skill

PRIORITY_MARKER_TUNGNT_AI_SKILLS_ONLY_VERSION
EOF

run_opencode output "$TEST_HOME/test-project" "Call the skill tool with name \"tungnt-ai-skills-only-test\". Show the exact content including any PRIORITY_MARKER text."
assert_contains "$output" "PRIORITY_MARKER_TUNGNT_AI_SKILLS_ONLY_VERSION" "Non-colliding tungnt-ai-skills skill is still registered"
