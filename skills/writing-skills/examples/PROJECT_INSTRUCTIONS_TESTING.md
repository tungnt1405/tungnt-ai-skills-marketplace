# Testing Project Instruction Skills Documentation
...
B) Check `skills/debugging/` first (2 min check + 5 min fix = 7 min)
...
A) Check `skills/testing/` for async testing skill
...
Do you:
A) Check `skills/coding/` for refactoring guidance
...
Instructions: `skills/using-tungnt-ai-skills`
</available_skills>
...
Start here: `skills/using-tungnt-ai-skills`
```
