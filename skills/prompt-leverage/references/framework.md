...
Use this reference to turn a raw prompt into a practical execution prompt while preserving the user's intent.

This reference was informed by the prompt-leverage examples in the linked source, but the framework here is maintained as part of this project.
...
- Emphasize manual trigger behavior, frontmatter discipline, supporting files, RED/GREEN expectations, and repository validation.
...
- Keep execution instructions compatible with the current project workflow.
