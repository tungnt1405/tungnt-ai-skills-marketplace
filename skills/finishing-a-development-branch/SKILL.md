...
**If worktree path is under `.worktrees/`, `worktrees/`, `~/.config/tungnt-ai-skills/worktrees/`, or legacy `~/.config/superpowers/worktrees/`:** tungnt-ai-skills created this worktree — we own cleanup.
...
- **Fix:** Only clean up worktrees under `.worktrees/`, `worktrees/`, `~/.config/tungnt-ai-skills/worktrees/`, or legacy `~/.config/superpowers/worktrees/`
