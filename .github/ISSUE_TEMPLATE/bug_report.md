...
| Field | Value |
|-------|-------|
| tungnt-ai-skills version | |
| Harness (Claude Code, Cursor, etc.) | |
| Harness version | |
| Model | |
| OS + shell | |

## Is this a tungnt-ai-skills issue or a platform issue?
<!-- tungnt-ai-skills is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without tungnt-ai-skills installed.

     If the problem persists without tungnt-ai-skills, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without tungnt-ai-skills installed
