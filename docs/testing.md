# Testing tungnt-ai-skills

This document describes how to test `tungnt-ai-skills`, particularly the integration tests for complex skills like `subagent-driven-development`.
...
- Must run from the `tungnt-ai-skills` plugin directory (not from temp directories)
- Claude Code must be installed and available as `claude` command
- Local development setup must load this fork's plugin/bootstrap correctly before running harness tests
...
```bash
# Example for /Users/yourname/Documents/GitHub/ai-skills
SESSION_DIR="$HOME/.claude/projects/-Users-yourname-Documents-GitHub-ai-skills"
...
**Solutions**:
1. Ensure you're running from the fork root: `cd /path/to/ai-skills && tests/...`
2. Check your harness/plugin setup is loading `using-tungnt-ai-skills` at session start
...
4. **Run from plugin dir**: Skills only load reliably when running from the fork root
