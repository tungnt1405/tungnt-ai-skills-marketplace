...
> **For agentic workers:** REQUIRED SUB-SKILL: Use tungnt-ai-skills:subagent-driven-development (recommended) or tungnt-ai-skills:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**Spec:** `docs/tungnt-ai-skills/specs/2026-03-23-codex-app-compatibility-design.md`
...
To:
```
- **tungnt-ai-skills:using-git-worktrees** - REQUIRED: Ensures isolated workspace (creates one or verifies existing)
```
...
**Files:**
- Modify: `skills/using-tungnt-ai-skills/references/codex-tools.md:25` (append at end)

- [ ] **Step 1: Read the current file**

Read `skills/using-tungnt-ai-skills/references/codex-tools.md` in full. Confirm it ends at line 25-26 after the multi_agent section.
...
```bash
git add skills/using-tungnt-ai-skills/references/codex-tools.md
