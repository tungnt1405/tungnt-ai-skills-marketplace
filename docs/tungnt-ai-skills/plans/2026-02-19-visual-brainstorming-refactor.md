...
> **For agentic workers:** REQUIRED: Use tungnt-ai-skills:subagent-driven-development (if subagents available) or tungnt-ai-skills:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
...
**Spec:** `docs/tungnt-ai-skills/specs/2026-02-19-visual-brainstorming-refactor-design.md`
