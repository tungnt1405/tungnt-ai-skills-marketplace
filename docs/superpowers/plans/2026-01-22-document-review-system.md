...
> **For agentic workers:** REQUIRED: Use tungnt-ai-skills:subagent-driven-development (if subagents available) or tungnt-ai-skills:executing-plans to implement this plan.
...
```markdown
> **For agentic workers:** REQUIRED: Use tungnt-ai-skills:subagent-driven-development (if subagents available) or tungnt-ai-skills:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
